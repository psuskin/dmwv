              ...
              >
                <div className="relative h-96">
                  ...
                  <div className="absolute bottom-0 left-0 p-6 text-white">
                    ...
                    <p className="text-sm opacity-75">{member[`role${locale === 'en' ? 'EN' : 'DE'}`]}</p>
                  </div>
                  <AnimatePresence>
                    {hoveredMember === index && (
                      <motion.div
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm mb-4">{member[`role${locale === 'en' ? 'EN' : 'DE'}`]}</p>
                          <p className="text-sm">{member[`team${locale === 'en' ? 'EN' : 'DE'}`]}</p>
                        </div>
